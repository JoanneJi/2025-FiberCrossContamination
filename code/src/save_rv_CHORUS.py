...
after looping through all traces in one observation with SNR set from 100 to 800,
and two cross-contamination settings:
    - conservative: calsci_frac = 1e-6; scisci_frac = 1e-3
    - optimized: calsci_frac = 1e-6; scisci_frac = 1e-4
    - Poisson noise and read noise are added
